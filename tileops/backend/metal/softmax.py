"""Metal row-wise softmax and log-softmax.

Mirrors :mod:`tileops.backend.cuda.softmax` with a separate in-process cache prefix.
...
matches the generated shader bindings.
"""
...
_compile_cache = make_generic_cached_compiler(cache_prefix="metal_softmax_v1")
