"""CUDA / HIP gather kernel (row-indexed gather along last axis of a 2-D view).

The facade in :mod:`tileops.indexing` permutes the gather dimension to the
last axis and flattens preceding dims into a single row dimension before
calling here.
"""
...
_compile = make_generic_cached_compiler(cache_prefix="cuda_indexing")
